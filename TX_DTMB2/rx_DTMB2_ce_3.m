...
spn_h_denoise_alpha_iter1 = 0.4;
spn_h_denoise_alpha_status_counter = 0;
...
channel_len_estimate_spn = zeros(length(SNR),sim_num);
mse_pos = 1;
      ...
      for i=1:sim_num-1
          ...
          for k = 1:iter_num            
              if k == 1
                  ...
                  h_iter = channel_denoise2(h_iter, spn_h_denoise_alpha_iter1);
                  ...
                  eq_data_freq(abs(h_freq)<spn_h_off_thresh) = 0;
          ...
          channel_tps_iter_off_mse = norm(h_tps_es - h_iter)/norm(h_tps_es);
          if channel_tps_iter_off_mse > 0.1
              spn_h_denoise_alpha_status_counter = spn_h_denoise_alpha_status_counter - 1;
          else
              spn_h_denoise_alpha_status_counter = spn_h_denoise_alpha_status_counter + 1;
          end
          if spn_h_denoise_alpha_status_counter < 0
              spn_h_denoise_alpha_status_counter = 0;
              spn_h_denoise_alpha_iter1 = 0.4;
          elseif spn_h_denoise_alpha_status_counter >= 3
              spn_h_denoise_alpha_status_counter = 3;
